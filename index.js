...
module.exports = {
  ...
  'rules': {
    ...
    'jest/unbound-method': OFF('I have not yet hit a situation where this matters, and it requires telling eslint which files are jest files which I would very much like to avoid'),
